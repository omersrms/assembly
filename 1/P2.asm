/*
   Halil Ibrahim Erdal  &  Omer Sarimese
      1901022264            1801022001
 */
...
.equ RCC_IOPENR,       (RCC_BASE   + (0x34)) // RCC IOPENR register offset   /* From rm0444-stm32g0x1 datasheet */

.equ GPIOC_BASE,       (0x50000800)          // GPIOC base address           /* From rm0444-stm32g0x1 datasheet */
